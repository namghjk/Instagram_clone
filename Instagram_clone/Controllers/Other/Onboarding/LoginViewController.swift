...
class LoginViewController: UIViewController {
    ...
    private func configureHeaderView(){
        ...
        guard let backkgroundView = headerView.subviews.first else {
            return
        }
        
        backkgroundView.frame = headerView.bounds
    ...
    @objc private func didTapTermsButton(){
        guard let url = URL(string: "https://www.instagram.com/about/legal/terms/before-january-19-2013/#:~:text=Basic%20Terms&text=You%20are%20responsible%20for%20any,any%20illegal%20or%20unauthorized%20purpose.") else{
            return
        }
